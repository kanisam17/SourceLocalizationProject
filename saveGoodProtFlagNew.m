...
folderSourceString = 'D:\Kanishq\NewProject\TLSAEEGProjectPrograms'; % Indicate the parent folder of decimatedData
...
folderName = 'D:\Kanishq\NewProject\TLSAEEGProjectPrograms\analyzedDataRandTrials\ADGammaProject\SF_ORI';
for i=1:length(uniqueSubjectNames)
    x = load(fullfile(folderName,[uniqueSubjectNames{i} '_unipolar_stRange_250_750.mat']));
    goodProtFlagList{i} = x.allProtocolsBLData.goodProtFlag;
